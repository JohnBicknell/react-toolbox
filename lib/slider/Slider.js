...
var factory = function factory(ProgressBar, Input) {
  var Slider = function (_Component) {
    ...
    _createClass(Slider, [{
      ...
      value: function positionToValue(position) {
        ...
        var val = this.trimValue((position.x - start) / length * (max - min) + min);
        if (this.props.points.length) {
          this.props.points.forEach(function (p) {
            if (Math.abs(val - p) <= _this2.props.pointSnap) {
              val = p;
            }
          });
        }
      ...
      key: 'valueToPosition',
      value: function valueToPosition(value) {
        var _state2 = this.state;
        var start = _state2.sliderStart;
        var length = _state2.sliderLength;
        var _props3 = this.props;
        var max = _props3.max;
        var min = _props3.min;

        return length / (max - min) * (value - min);
      }
    }, {
      key: 'start',
      value: function start(position) {
        ...
        this.handleResize(null, function () {
          ...
          _this3.props.onChange(_this3.positionToValue(position));
        });
      }
    }, {
      key: 'stepDecimals',
        ...
        if (this.props.snaps) {
          return _react2.default.createElement(
            ...
            _utils2.default.range(0, (this.props.max - this.props.min) / this.props.step).map(function (i) {
              return _react2.default.createElement('div', { key: 'span-' + i, className: _this4.props.theme.snap });
            })
          );
        }
      }
      ...
      value: function renderPoints() {
        ...
        if (this.props.points.length) {
          return _react2.default.createElement(
            'div',
            { ref: 'points', className: this.props.theme.points },
            this.props.points.map(function (i) {
              return _react2.default.createElement('div', { key: 'span-' + i, style: { left: _this5.valueToPosition(i) + 'px' }, className: _this5.props.theme.point });
            })
          );
        }
      }
  ...
  Slider.propTypes = {
    ...
    pointSnap: _react.PropTypes.number,
